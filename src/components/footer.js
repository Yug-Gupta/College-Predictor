      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-brand">
            ...
            <p>This UPTAC College Predictor was built by Yug Gupta to help students find suitable colleges based on rank, category, and preferences.</p>
          </div>
        ...
        <div class="footer-bottom">
          ...
          <div class="footer-attribution">
            ...
            <span class="footer-attr-name">Yug Gupta</span>
