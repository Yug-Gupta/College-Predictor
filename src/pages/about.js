    ...
    <div class="about-page">
      <div class="container">
        ...
        <div class="about-content">
          <h2 class="reveal">Our Purpose</h2>
          <p class="reveal">UPTAC College Predictor 2026 is a free, open-source tool designed to help JEE Main aspirants predict their chances of admission at various AKTU-affiliated engineering colleges in Uttar Pradesh.</p>
          <p class="reveal">We believe every student deserves access to data-driven decision-making tools. Our predictor uses real counselling data from 2025 to estimate admission chances for the upcoming 2026 UPTAC counselling cycle.</p>

          <h2 class="reveal">How It Works</h2>
          <p class="reveal">The prediction engine works by matching your JEE Main rank against <strong>official opening and closing rank data</strong> from the UPTAC 2025 B.Tech Counselling OR-CR report (admissions.nic.in). We apply a 5% adjustment factor to account for year-over-year variations in cutoff trends.</p>
          <p class="reveal">Each college-branch combination is classified into three chance levels:</p>
          <ul style="list-style:disc;padding-left:1.5rem;margin:0.75rem 0;" class="reveal">
          ...
          <h2 class="reveal">Data Sources</h2>
          <p class="reveal">Our dataset is sourced <strong>entirely from the official UPTAC counselling portal</strong> (<a href="https://uptac.admissions.nic.in" target="_blank" rel="noopener" style="color:var(--accent-primary);text-decoration:underline;">uptac.admissions.nic.in</a>). All 10,804 records were extracted directly from the official OR-CR (Opening Rank / Closing Rank) report for B.Tech 2025.</p>
          <p class="reveal">The dataset covers <strong>200 colleges</strong> with <strong>50 B.Tech branches</strong>, across all official categories (OPEN, BC, SC, ST, EWS, and subcategories), both Home State and All India quotas, and all counselling rounds.</p>
          ...
          <div class="grid grid-2 gap-md" style="margin:1rem 0;">
            <div class="card reveal" style="padding:1.25rem;">
          ...
          <p class="reveal">Built with modern web technologies for performance and reliability:</p>
          <div style="display:flex;flex-wrap:wrap;gap:0.5rem;margin:0.75rem 0;" class="reveal">
          ...
          <p class="reveal">This is an open-source project. Contributions are welcome! If you have access to updated UPTAC cutoff data, bug fixes, or feature suggestions, feel free to contribute.</p>

          <h2 class="reveal">Contact</h2>
          <p class="reveal">For questions, suggestions, or data corrections, please reach out through the GitHub repository.</p>
          
          <div style="text-align:center;margin-top:2rem;padding-top:2rem;border-top:1px solid var(--border-light);" class="reveal">
